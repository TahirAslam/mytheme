...
wp_add_dashboard_widget('custom_help_widget', 'Scan WP - Message', 'scanwp_admin_msg_text');
}
function scanwp_admin_msg_text() {
echo '<p>This custom theme was created by <a href="http://scanwp.net">Scan WP</a>. For assistance contact us <a href="mailto:info@yourdomain.com" target="_blank">this email</a></p>';
}
...
?>
<?php if ( is_active_sidebar( 'scanwp_sidebar' ) ) : ?>
  <div id="special-footer-text" class="special-footer-text">
  <?php dynamic_sidebar( 'scanwp_sidebar' ); ?>
  </div>
<?php endif;
